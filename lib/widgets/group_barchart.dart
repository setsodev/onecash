...
import 'package:onecash/models/domain.dart';
import 'package:onecash/widgets/line.dart';
...
class _GroupedBarChartState extends State<GroupedBarChart> {
  ...
  Widget _buildBarCharts() {
    ...
    return Container(
      ...
      child: ListView.builder(
            ...
            child: Container(
              ...
              child: InkWell(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    _buildPlot(
                        _getDomainValue(widget.series[0].measureFn(index),
                            maxValue, factor),
                        width,
                        0,
                    ...
                    _buildPlot(
                        _getDomainValue(widget.series[1].measureFn(index),
                            maxValue, factor),
                        width,
                        2,
        ...
        itemCount:
            max(widget.series[0].data.length, widget.series[1].data.length),
        shrinkWrap: true,
  ...
  Widget _buildPlot(double height, double width, int rotation, Color color,
      double maxHeight) {
    return Container(
      height: maxHeight,
